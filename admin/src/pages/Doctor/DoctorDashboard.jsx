    ...
    <div className='m-5'>
      <div className='flex flex-wrap gap-3'>
              ...
              <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transiton-all'>
                ...
                <div>
                  <p className='txt-xl font-semibold text-gray-600'>{currency} {dashData.earnings}</p>
              ...
              <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transiton-all'>
                ...
                <div>
                  <p className='txt-xl font-semibold text-gray-600'>{dashData.appointments}</p>
              ...
              <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transiton-all'>
                ...
                <div>
                  <p className='txt-xl font-semibold text-gray-600'>{dashData.patients}</p>
