...
//         {
//           isEdit 
//           ? <button className='border border-primary px-8 py-2 rounded-ful hover:bg-primary hover:text-white transition-all' onClick={updateUserProfileData}>Save information</button>
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      {isEdit ? (
        ...
        userData.image
          ...
          : <div className="w-36 h-36 bg-gray-200 rounded flex items-center justify-center text-gray-500">No Image</div>
      )}
